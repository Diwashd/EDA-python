...
now from this table give as much detailed inforation you can provide in the contect of EDA in python. in detail ''' Now make a list od all the command and give a brief description of each.
